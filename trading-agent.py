...
# ===== CONFIG =====
# To get the bot token, Open Telegram. Search for BotFather, Create a new bot and you will get a HTTP api, copy and paste it
BOT_TOKEN = ""

# To get the chat id, Open Telegram. Search for userinfobot, Type /start and you will get your id, paste it here.
CHAT_ID = ""
